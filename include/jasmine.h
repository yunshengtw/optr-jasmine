...
#define OPTION_SUPPORT_TRIM     0
#define OPTION_TEST_NAND_BLK    0
...
#define NUM_LSECTORS	(NUM_PSECTORS  / 100 * 70) // 30% provisioning
//#define NUM_LSECTORS	(NUM_PSECTORS  / 100 * 86) // 14% provisioning
// #define NUM_LSECTORS	(NUM_PSECTORS  / 100 * 93) // 7% provisioning
// #define NUM_LSECTORS	(NUM_PSECTORS  / 100 * 18) // 82% provisioning
